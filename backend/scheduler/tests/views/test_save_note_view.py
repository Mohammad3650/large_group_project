...
class SaveNoteViewTest(TestCase):
    ...
    def test_save_note_returns_200_with_valid_data(self):
        ...
        response = self.client.put("/api/notes/save/", {"content": "Updated content"}, format="json")
    ...
    def test_save_note_updates_content(self):
        ...
        response = self.client.put("/api/notes/save/", {"content": "New content"}, format="json")
    ...
    def test_save_note_creates_note_if_not_exists(self):
        ...
        self.client.put("/api/notes/save/", {"content": "New note"}, format="json")
    ...
    def test_save_note_persists_to_database(self):
        ...
        self.client.put("/api/notes/save/", {"content": "Persisted content"}, format="json")
    ...
    def test_save_note_requires_authentication(self):
        ...
        response = self.client.put("/api/notes/save/", {"content": "Test"}, format="json")
    ...
    def test_save_note_returns_400_when_serializer_is_invalid(self, MockSerializer):
        ...
        # mocking the serializer so that it returns false for is_valid
