...
/**
 * Restores a task to the appropriate date-group task list based on its date.
 *
 * @param {Object} task - The task to restore
 * @param {Object} setters - State setter functions for each date group
 ...
 */
function restoreTaskToDateGroup(task, { setOverdueTasks, setTodayTasks, setTomorrowTasks, setWeekTasks, setBeyondWeekTasks }) {
    ...
    setter((prev) => [...prev, task].sort(sortTasksByDate));
}

export default restoreTaskToDateGroup;