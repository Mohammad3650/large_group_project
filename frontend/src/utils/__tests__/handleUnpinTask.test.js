...
import handleUnpinTask from '../Helpers/handleUnpinTask.js';

vi.mock('../Api/unpinTimeBlock.js', () => ({ default: vi.fn() }));
vi.mock('../Helpers/restoreTaskToDateGroup.js', () => ({ default: vi.fn() }));

import * as unpinTimeBlockModule from '../Api/unpinTimeBlock.js';
import * as restoreTaskToDateGroupModule from '../Helpers/restoreTaskToDateGroup.js';
