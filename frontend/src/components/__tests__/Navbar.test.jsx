...
vi.mock('../../assets/Navbar/task_list.png', () => ({
    default: 'task_list.png'
}));
vi.mock('../../assets/calendar_icon.png', () => ({
    default: 'calendar_icon.png'
}));
...
describe('Navbar', () => {
    ...
    describe('when the user is not logged in', () => {
        ...
        it('renders the site title linking to /', async () => {
            ...
            expect(screen.getByText('StudySync').closest('a')).toHaveAttribute(
                'href',
                '/'
            );
        });
    ...
    describe('when the user is logged in', () => {
        ...
        it("does not render the 'Built for Students' tagline", async () => {
            ...
            expect(
                screen.queryByText('Built for Students')
